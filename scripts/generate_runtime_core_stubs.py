...
FUNCTION_TYPES: dict[str, dict[str, str]] = {
    ...
    "manifold_signed_distance": {"c": "complex", RET: "float"},
    "manifold_regularized_distance": {
        "c": "complex",
        "epsilon": "float",
        RET: "float",
    },
    "manifold_mandelbrot_scale": {
        "c": "complex",
    ...
    "manifold_potential_force": {
        "c": "complex",
        "config": "ManifoldConfig",
        RET: "tuple[float, float]",
    },
    "manifold_apply_generalized_force": {
        "qx": "float",
        "qy": "float",
        "c": "complex",
        "config": "ManifoldConfig",
    ...
    "geometry_provider_query": {"c": "complex", "epsilon": "float", RET: "str"},
    "geometry_provider_version": {RET: "str"},
    "geometry_provider_scale_alpha": {RET: "float"},
}
...
CLASS_METHOD_TYPES: dict[str, dict[str, dict[str, str]]] = {
    ...
    "OrbitController": {
        ...
        "debug_snapshot": {RET: "dict[str, object]"},
    },
    "AnalysisTimebase": {
        "__init__": {RET: "None"},
        "ingest": {
...
FUNCTION_ORDER = [
    ...
    "manifold_drag_force",
    "manifold_integrate_step",
    "geometry_provider_query",
    "geometry_provider_version",
    "geometry_provider_scale_alpha",
]
