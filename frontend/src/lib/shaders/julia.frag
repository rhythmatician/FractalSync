// DEPRECATED: This file is kept for historical reasons but is NOT the canonical
// shader. The frontend fetches the canonical shader at runtime from
// `/api/shader/julia.frag`. Edit `shared/shaders/julia.frag` instead.
