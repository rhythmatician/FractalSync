...
- `src/lib/canonicalFeatures.ts` — Canonical audio feature extraction via `wasm-orbit` (Rust `runtime-core`; the former JS reimplementation `audioFeatures.ts` has been removed — see ADR 0001)
