...
class TestAudioDataset:
    ...
    def test_dataset_empty_directory(self, temp_cache_dir):
        ...
        with pytest.raises(ValueError, match="No audio files found"):
            AudioDataset(data_dir=str(empty_dir), cache_dir=str(temp_cache_dir))
    ...
    def test_dataset_max_files(self, temp_audio_dir, temp_cache_dir):
        ...
        dataset = AudioDataset(
            data_dir=str(temp_audio_dir), max_files=2, cache_dir=str(temp_cache_dir)
        )
    ...
    def test_dataset_no_cache(self, temp_audio_dir):
        ...
        dataset = AudioDataset(
            data_dir=str(temp_audio_dir), cache_dir=None  # No caching
        )
    ...
    def test_cache_invalidation_on_file_modification(
        self, temp_audio_dir, temp_cache_dir
    ):
    ...
    def test_cache_directory_creation(self):
        ...
        AudioDataset(data_dir=str(audio_dir), cache_dir=str(cache_dir))
...
class TestAudioDatasetEdgeCases:
    ...
    def test_negative_max_files(self, temp_audio_dir, temp_cache_dir):
        ...
        dataset = AudioDataset(
            data_dir=str(temp_audio_dir), max_files=-1, cache_dir=str(temp_cache_dir)
        )
