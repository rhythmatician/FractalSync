...
def test_mandelbrot_distance_estimate(c_real, c_imag, expected_distance):
    ...
    assert abs(calculated_distance - expected_distance) < 0.05, (
        f"Distance estimate {calculated_distance} differs from expected "
        f"{expected_distance} by more than tolerance."
    )
