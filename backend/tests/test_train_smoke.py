"""Lightweight end-to-end smoke test for training entrypoint.

Creates a tiny synthetic WAV file and runs `python train.py` with minimal
settings to ensure the training script completes and writes outputs.
"""
...
def _write_sine_wav(path: Path, duration_s: float = 0.5, sr: int = 22050):
...
def test_train_smoke(tmp_path):
    ...
    # Check that save_dir exists and training history file may be referenced
