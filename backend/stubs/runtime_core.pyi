...
class ResidualParams:
    ...
    class DistanceField:
        ...
        def gradient(self, c: Complex) -> tuple[float, float]: ...

class DistanceField:
    """Top-level runtime_core DistanceField binding."""
    ...
    def lookup(self, c: Complex) -> float: ...
    def sample_bilinear(self, c: Complex) -> float: ...
    def gradient(self, real: float, imag: float) -> tuple[float, float]: ...
    def get_velocity_scale(self, c: Complex) -> float: ...
    def velocity_scale(self, escape_time: float) -> float: ...
